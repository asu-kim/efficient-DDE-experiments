...
bin_path="../bin"
lfc_path="../lingua-franca-solution/bin/lfc-dev"
rti_relative_path="../lingua-franca-solution/core/src/main/resources/lib/c/reactor-c/core/federated/RTI/build/RTI"
