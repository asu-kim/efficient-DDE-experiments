...
set output 'DistanceSensingLags.pdf'
...
y1 = 0; y2 = 4.5; y3 = 1434; y4 = 1547; y5 = 15332; y6 = 15404
...
plot 'DistanceSensingHLA_likeStatistics.csv' using ($2 <= 20 ? 3*$1-xx : 1/0):3:(ww) lt 1 w boxes notitle,\
    ...
    'DistanceSensingSOTAStatistics.csv' using ($2 <= 20 ? 3*$1 : 1/0):3:(ww) lt 2 w boxes notitle,\
    ...
    'DistanceSensingSolutionStatistics.csv' using ($2 <= 20 ? 3*$1+xx : 1/0):3:(ww) lt 4 w boxes title 'Our Solution',\
    '' using ($2 <= 20 ? 3*$1+xx : 1/0):3:(sprintf("{/Symbol m}: %.2f", $3)) w labels offset 0,1.4 font ",12" notitle,\
    '' using ($2 <= 20 ? 3*$1+xx : 1/0):3:(sprintf("{/Symbol s}: %.1f", $4)) w labels offset 0,0.6 font ",12" notitle
...
plot 'DistanceSensingHLA_likeStatistics.csv' using ($2 <= 20 ? 3*$1-xx : 1/0):3:(ww) lt 1 w boxes notitle,\
    ...
    'DistanceSensingSOTAStatistics.csv' using ($2 <= 20 ? 3*$1 : 1/0):3:(ww) lt 2 w boxes title 'SOTA',\
    ...
    'DistanceSensingSolutionStatistics.csv' using ($2 <= 20 ? 3*$1+xx : 1/0):3:(ww) lt 4 w boxes notitle
...
# Top plot
plot 'DistanceSensingHLA_likeStatistics.csv' using ($2 <= 20 ? 3*$1-xx : 1/0):3:(ww) lt 1 w boxes title 'HLA-like',\
