...
plot 'DistanceSensingHLA_likeStatistics.csv' using (3*$1-xx):3:(ww) lt 1 w boxes notitle,\
    ...
    'DistanceSensingSOTAStatistics.csv' using (3*$1):3:(ww) lt 2 w boxes notitle,\
    ...
    'DistanceSensingSolutionStatistics.csv' using (3*$1+xx):3:(ww) lt 4 w boxes title 'Our Solution',\
    '' u (3*$1+xx):3:(sprintf("{/Symbol m}: %.2f", $3)) w labels offset 0,1.4 font ",12" notitle,\
    '' u (3*$1+xx):3:(sprintf("{/Symbol s}: %.1f", $4)) w labels offset 0,0.6 font ",12" notitle
...
plot 'DistanceSensingHLA_likeStatistics.csv' using (3*$1-xx):3:(ww) lt 1 w boxes notitle,\
    ...
    'DistanceSensingSOTAStatistics.csv' using (3*$1):3:(ww) lt 2 w boxes title 'SOTA',\
    ...
    'DistanceSensingSolutionStatistics.csv' using (3*$1+xx):3:(ww) lt 4 w boxes notitle
...
set yrange [y5:y6]
plot 'DistanceSensingHLA_likeStatistics.csv' using (3*$1-xx):3:(ww) lt 1 w boxes title 'HLA-like',\
